...
export default function PaintMixer() {
  ...
  return (
    <div className="flex h-screen w-full text-zinc-100 font-sans selection:bg-emerald-500 overflow-hidden">
      ...
      {notification && (
        <div className={`fixed bottom-8 left-1/2 -translate-x-1/2 px-8 py-4 rounded-3xl shadow-2xl z-50 animate-in fade-in slide-in-from-bottom-10 flex items-center gap-3 ${notification.type === 'success' ? 'bg-emerald-600' : 'bg-zinc-800'
          }`}>
          {notification.type === 'success' ? <CheckCircle2 size={20} className="text-emerald-400" /> : <Printer size={20} className="text-zinc-400" />}
