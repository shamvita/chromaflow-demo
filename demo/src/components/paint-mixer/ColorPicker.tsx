                ...
                <div className="flex-1 flex flex-col min-h-0">
                    ...
                    <div className="flex-1 overflow-y-auto pr-2 space-y-3 custom-scrollbar">
                        {matches.map(({ item, distance }) => {
                            // LAB Delta E Distance 76:
                            // < 1.0: Imperceptible
                            // < 2.3: Recommended threshold for "matched"
                            // < 10: Close match
                            // 100: Max distance in sRGB gamut roughly
                            const matchPercent = Math.max(0, 100 - (distance * 1.5));
                            const isExact = distance < 2.3;
                                ...
                                >
                                    ...
                                    <div className="flex-1 min-w-0">
                                        <div className="flex items-center gap-2 mb-1">
                                            <span className={`text-[10px] font-black px-2 py-0.5 rounded-full uppercase tracking-wider ${item.category === 'personalizados'
