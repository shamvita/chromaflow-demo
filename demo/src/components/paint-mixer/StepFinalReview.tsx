    ...
    <>
      ...
      <div className="hidden print-container flex-col bg-white text-black font-sans box-border p-4 relative">
        ...
        <div className="mt-auto pt-2">
          ...
          <div className="border-t-4 border-black pt-1 flex justify-between items-center bg-zinc-100 p-2 relative overflow-hidden">
            ...
            {/* QR Code for Formula Tracking */}
            <div className="relative z-10 bg-white p-1 border border-zinc-200 shadow-sm rounded-sm">
              <img
                src={`https://api.qrserver.com/v1/create-qr-code/?size=100x100&data=${encodeURIComponent(JSON.stringify({
                  c: currentMix.customerName,
                  col: currentMix.colorName,
              ...
              />
              <div className="text-[6px] font-black uppercase text-center mt-0.5 leading-none">Scan Form</div>
            </div>
          </div>
      ...
      <div className="h-full flex flex-col animate-in fade-in slide-in-from-bottom-4 duration-500 print:hidden">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 flex-1 overflow-y-auto px-2">
                  ...
                  {currentMix.bases.map((mixBase: MixBase) => (
                    <div key={mixBase.product.id} className="flex-1 bg-zinc-950/30 border border-zinc-800/50 rounded-xl p-3 flex items-center justify-between min-w-0">
                      <div className="flex items-center gap-3 min-w-0">
                        <PaintBucket size={16} className="text-emerald-400 shrink-0" />
        ...
        <div className="mt-6 flex gap-3 items-start shrink-0">
          ...
          <div className="flex-2 flex flex-col gap-2">
            <button
              ...
              className={`w-full h-14 rounded-2xl font-black uppercase text-xs shadow-lg flex items-center justify-center gap-3 transition-all ${currentMix.customerName && currentMix.colorName
